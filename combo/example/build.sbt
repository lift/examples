...
libraryDependencies ++= {
  ...
  Seq(
    ...
    // "net.liftmodules" %% "fobo_3.3" % "2.1.1",
    "net.liftmodules" %% "fobo-twbs-bootstrap4_3.3" % "2.1.1",
    "net.liftmodules" %% "fobo-popper_3.3" % "2.1.1",
    "net.liftmodules" %% "fobo-font-awesome_3.3" % "2.1.1",
    "net.liftmodules" %% "fobo-highlightjs_3.3" % "2.1.1",
    "net.liftmodules" %% "fobo-jquery_3.3" % "2.1.1",
